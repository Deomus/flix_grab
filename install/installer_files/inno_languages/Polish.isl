...
WelcomeLabel2=Klikaj¹c "Dalej" zgadzasz siê na warunki Umowy licencyjnej u¿ytkownika koñcowego i Polityki prywatnoœci.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nwersja %1
readEULA=Przeczytaj FreeGrabApp EULA i Politykê Prywatnoœci
installOldVer=Próbujesz zainstalowaæ star¹ wersjê programu. Czy chcesz teraz pobraæ najnowsz¹?
checkInternetConnection=Instalator nie mo¿e zweryfikowaæ swoich komponentów.%nSprawdŸ swoje po³¹czenie internetowe i naciœnij 'Ok' lub kliknij 'Anuluj', aby zakoñczyæ instalacjê.
checkInternetConnectionOk=Instalator nie jest w stanie zweryfikowaæ swoich sk³adników.%nProszê sprawdziæ po³¹czenie internetowe.
productslbl=Darmowy