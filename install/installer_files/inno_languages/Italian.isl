...
WelcomeLabel2=Facendo clic su "Avanti" si accettano i termini e le condizioni degli Accordi di licenza con l'utente finale e dell'Informativa sulla privacy.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nversione %1
readEULA=Leggi l'EULA e l'informativa sulla privacy di FreeGrabApp
installOldVer=Stai cercando di installare una vecchia versione del programma. Vuoi scaricare l'ultima adesso?
checkInternetConnection=L'installatore non è in grado di verificare i suoi componenti.%nPer favore controlla la tua connessione Internet e premi 'Ok' o clicca 'Annulla' per terminare il setup.
checkInternetConnectionOk=L'installatore non è in grado di verificare i suoi componenti.%nControlla la tua connessione Internet.
productslbl=Gratuito