...
WelcomeLabel2="अगला" पर क्लिक करके आप अंतिम उपयोगकर्ता लाइसेंस समझौतों और गोपनीयता नीति के नियमों और शर्तों से सहमत होते हैं।
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nसंस्करण %1
readEULA=FreeGrabApp EULA और गोपनीयता नीति पढ़ें
installOldVer=आप प्रोग्राम के पुराने संस्करण को स्थापित करने का प्रयास कर रहे हैं। क्या आप अभी नवीनतम डाउनलोड करना चाहते हैं?
checkInternetConnection=इंस्टालर अपने घटकों को सत्यापित करने में असमर्थ है।%nकृपया अपना इंटरनेट कनेक्शन जांचें और 'ओके' दबाएं या सेटअप समाप्त करने के लिए 'रद्द करें' पर क्लिक करें।
checkInternetConnectionOk=इंस्टालर इसके घटकों को सत्यापित करने में असमर्थ है।%nकृपया अपना इंटरनेट कनेक्शन जांचें।
productslbl=मुक्त