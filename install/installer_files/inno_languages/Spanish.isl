...
WelcomeLabel2=Al hacer clic en "Siguiente", usted acepta los términos y condiciones de los Acuerdos de Licencia de Usuario Final y la Política de Privacidad.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nversión %1
readEULA=Leer el EULA y la política de privacidad de FreeGrabApp
installOldVer=Está intentando instalar una versión antigua del programa. ¿Quiere descargar la más reciente ahora?
checkInternetConnection=El instalador no puede verificar sus componentes.%nPor favor, compruebe su conexión a Internet y pulse 'Ok' o haga clic en 'Cancelar' para finalizar la instalación.
checkInternetConnectionOk=El instalador no puede verificar sus componentes.%nPor favor, compruebe su conexión a Internet.
productslbl=Gratis