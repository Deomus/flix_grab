...
WelcomeLabel2=By clicking "Next" you agree to the terms and conditions of the End User License Agreements and Privacy Policy.
...
readEULA=Read FreeGrabApp EULA and Privacy Policy
installOldVer=You are trying to install an old version of the program. Do you want to download the latest now?
checkInternetConnection=Installer is unable to verify its components.%nPlease check your Internet connection and press 'Ok' or click 'Cancel' to terminate setup.
checkInternetConnectionOk=Installer is unable to verify its components.%nPlease check your Internet connection.
productslbl=Free