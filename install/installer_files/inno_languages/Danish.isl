...
WelcomeLabel2=Ved at klikke på "Næste" accepterer du vilkårene og betingelserne i slutbrugerlicensaftalerne og privatlivspolitikken.
...
readEULA=Læs FreeGrabApp EULA og fortrolighedspolitik
installOldVer=Du forsøger at installere en gammel version af programmet. Ønsker du at downloade den nyeste version nu?
checkInternetConnection=Installationsprogrammet kan ikke verificere dets komponenter.%nKontroller venligst din internetforbindelse, og tryk på 'Ok' eller klik på 'Annuller' for at afslutte installationen.
checkInternetConnectionOk=Installationsprogrammet kan ikke verificere dets komponenter.%nKontroller venligst din internetforbindelse.
productslbl=Gratis