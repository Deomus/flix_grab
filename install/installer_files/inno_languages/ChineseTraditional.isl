...
WelcomeLabel2=單擊“下一步”即表示您同意最終用戶許可協議和隱私政策的條款和條件。
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%n版本 %1
readEULA=閱讀 FreeGrabApp EULA 和隱私政策
installOldVer=您正在嘗試安裝該程序的舊版本。 你想現在下載最新的嗎？
checkInternetConnection=安裝程序無法驗證其組件。%n請檢查您的 Internet 連接並按“確定”或單擊“取消”以終止安裝。
checkInternetConnectionOk=安裝程序無法驗證其組件。%n請檢查您的 Internet 連接。
productslbl=自由的