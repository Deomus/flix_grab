...
WelcomeLabel2=Wenn Sie auf "Weiter" klicken, erklären Sie sich mit den Bedingungen der Endbenutzer-Lizenzvereinbarungen und der Datenschutzrichtlinie einverstanden.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nVersion %1
readEULA=FreeGrabApp EULA und Datenschutzrichtlinie lesen
installOldVer=Sie versuchen, eine alte Version des Programms zu installieren. Möchten Sie jetzt die neueste Version herunterladen?
checkInternetConnection=Das Installationsprogramm kann seine Komponenten nicht verifizieren.%nBitte überprüfen Sie Ihre Internetverbindung und drücken Sie auf "Ok" oder klicken Sie auf "Abbrechen", um die Installation zu beenden.
checkInternetConnectionOk=Das Installationsprogramm kann seine Komponenten nicht verifizieren.%nBitte überprüfen Sie Ihre Internetverbindung.
productslbl=Frei