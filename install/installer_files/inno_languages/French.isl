...
WelcomeLabel2=En cliquant sur "Suivant", vous acceptez les termes et conditions des accords de licence de l'utilisateur final et de la politique de confidentialité.
...
readEULA=Lire le EULA et la politique de confidentialité de FreeGrabApp
installOldVer=Vous essayez d'installer une ancienne version du programme. Voulez-vous télécharger la dernière version maintenant ?
checkInternetConnection=Le programme d'installation n'a pas pu vérifier ses composants. Veuillez vérifier votre connexion Internet et appuyez sur 'Ok' ou cliquez sur 'Annuler' pour terminer l'installation.
checkInternetConnectionOk=L'installateur ne parvient pas à vérifier ses composants. Veuillez vérifier votre connexion Internet.
productslbl=Gratuit