...
WelcomeLabel2=Ao clicar em "Seguinte" concorda com os termos e condições dos Acordos de Licença de Utilizador Final e Política de Privacidade.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nversão %1
readEULA=Leia FreeGrabApp EULA e Política de Privacidade
installOldVer=Está a tentar instalar uma versão antiga do programa. Deseja descarregar a mais recente agora?
checkInternetConnection=O instalador não consegue verificar os seus componentes.%nPlease verifique a sua ligação à Internet e prima 'Ok' ou clique em 'Cancelar' para terminar a configuração.
checkInternetConnectionOk=O instalador não consegue verificar os seus componentes.%nPor favor, verifique a sua ligação à Internet.
productslbl=Grátis