...
WelcomeLabel2="Ýleri" düðmesine týklayarak Son Kullanýcý Lisans Sözleþmeleri ve Gizlilik Politikasýnýn hüküm ve koþullarýný kabul etmiþ olursunuz.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nsürüm %1
readEULA=FreeGrabApp EULA ve Gizlilik Politikasýný okuyun
installOldVer=Programýn eski bir sürümünü yüklemeye çalýþýyorsunuz. Þimdi en son sürümünü indirmek ister misiniz?
checkInternetConnection=Yükleyici bileþenlerini doðrulayamýyor.%nLütfen Ýnternet baðlantýnýzý kontrol edin ve 'Tamam'a basýn veya kurulumu sonlandýrmak için 'Ýptal'e týklayýn.
checkInternetConnectionOk=Yükleyici bileþenlerini doðrulayamýyor.%nLütfen Ýnternet baðlantýnýzý kontrol edin.
productslbl=Ücretsiz