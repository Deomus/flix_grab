...
WelcomeLabel2=Kliknutím na tlaèítko "Další" souhlasíte s podmínkami licenèních smluv s koncovım uivatelem a zásadami ochrany osobních údajù.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nverze %1
readEULA=Pøeètìte si smlouvu EULA a zásady ochrany osobních%núdajù aplikace FreeGrabApp
installOldVer=Snaíte se nainstalovat starší verzi programu. Chcete si nyní stáhnout nejnovìjší verzi?
checkInternetConnection=Instalaèní program nemùe ovìøit své souèásti.%nProsím, zkontrolujte pøipojení k internetu a stisknìte tlaèítko "Ok" nebo kliknìte na tlaèítko "Zrušit" pro ukonèení instalace.
checkInternetConnectionOk=Instalaèní program nemùe ovìøit své souèásti.%nProsím, zkontrolujte pøipojení k internetu.
productslbl=Zdarma