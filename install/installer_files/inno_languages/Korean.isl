...
WelcomeLabel2="다음"을 클릭하면 최종 사용자 사용권 계약 및 개인 정보 보호 정책의 조건에 동의하는 것입니다.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%n버전 %1
readEULA=FreeGrabApp EULA 및 개인 정보 보호 정책 읽기
installOldVer=이전 버전의 프로그램을 설치하려고 합니다. 지금 최신 버전을 다운로드하시겠습니까?
checkInternetConnection=설치 프로그램이 구성 요소를 확인할 수 없습니다.%n인터넷 연결을 확인하고 '확인'을 누르거나 '취소'를 클릭하여 설치를 종료하십시오.
checkInternetConnectionOk=설치 프로그램이 구성 요소를 확인할 수 없습니다.%n인터넷 연결을 확인하십시오.
productslbl=무료