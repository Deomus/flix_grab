...
WelcomeLabel2=Door op "Volgende" te klikken gaat u akkoord met de voorwaarden van de Eindgebruikersovereenkomst en het Privacybeleid.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nversie %1
readEULA=Lees FreeGrabApp EULA en privacybeleid
installOldVer=U probeert een oude versie van het programma te installeren. Wilt u de nieuwste nu downloaden?
checkInternetConnection=Het installatieprogramma kan de onderdelen niet verifiëren.%nVerifieer uw internetverbinding en druk op 'Ok' of klik op 'Annuleren' om de installatie te beëindigen.
checkInternetConnectionOk=Het installatieprogramma kan de onderdelen niet verifiëren.%nVerifieer uw internetverbinding.
productslbl=Gratis