...
WelcomeLabel2=Нажав кнопку "Далее", вы соглашаетесь с условиями лицензионных соглашений с конечным пользователем и политикой конфиденциальности.
...
; *** FreeGrabAppMessages
welcomeLabel1Custom=%nверсия %1
readEULA=Прочитать EULA и Политику конфиденциальности
installOldVer=Вы пытаетесь установить старую версию программы. Вы хотите загрузить последнюю версию сейчас?
checkInternetConnection=Программа установки не может проверить свои компоненты.%nПожалуйста, проверьте подключение к Интернету и нажмите "Ок" или нажмите "Отмена", чтобы завершить установку.
checkInternetConnectionOk=Программа установки не может проверить свои компоненты.%nПожалуйста, проверьте подключение к Интернету.
productslbl=Бесплатно