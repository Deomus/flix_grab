...
WelcomeLabel2=Genom att klicka på "Nästa" godkänner du villkoren i licensavtalen för slutanvändare och sekretesspolicyn.
...
readEULA=Läs FreeGrabApp EULA och sekretesspolicy
installOldVer=Du försöker installera en gammal version av programmet. Vill du ladda ner den senaste versionen nu?
checkInternetConnection=Installeraren kan inte verifiera sina komponenter.%nVänligen kontrollera din Internetanslutning och tryck på "Ok" eller klicka på "Cancel" för att avsluta installationen.
checkInternetConnectionOk=Installeraren kan inte verifiera sina komponenter.%nKontrollera din Internetanslutning.
productslbl=Gratis