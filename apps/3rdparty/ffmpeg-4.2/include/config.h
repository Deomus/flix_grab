...
#define FFMPEG_CONFIGURATION "--enable-shared --prefix=/local32 --bindir=/local32/bin-video --pkg-config-flags=--static --disable-filters --disable-doc --disable-autodetect --enable-debug --enable-dxva2 --enable-libopus --enable-libvorbis --enable-libx264 --enable-gpl --enable-version3 --enable-x86asm --enable-asm --enable-protocol=file --enable-protocol=subfile --enable-protocol=pipe --enable-protocol=http --enable-protocol=httpproxy --enable-protocol=https --enable-muxer=mp4 --enable-muxer=h264 --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=ac3 --enable-demuxer=srt --enable-muxer=matroska --enable-demuxer=matroska --enable-encoder=srt --enable-encoder=movtext --enable-schannel"
...
#define CC_IDENT "gcc 9.2.0 (Rev2, Built by MSYS2 project)"
