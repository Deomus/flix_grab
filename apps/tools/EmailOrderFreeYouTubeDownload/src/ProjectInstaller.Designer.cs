namespace EmailOrder
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // EmailOrderInstaller
            // 
            this.EmailOrderInstaller.Description = "Complete License Key by order form email FreeYouTubeDownload";
            this.EmailOrderInstaller.DisplayName = "Email Order Service FreeYouTubeDownload";
            this.EmailOrderInstaller.ServiceName = "EmailOrderServiceFreeYouTubeDownload";
