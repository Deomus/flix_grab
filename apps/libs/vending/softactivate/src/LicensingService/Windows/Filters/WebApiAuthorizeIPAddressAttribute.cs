...
{
    public class WebApiAuthorizeIPAddressAttribute : System.Web.Http.Filters.ActionFilterAttribute
    {
        public WebApiAuthorizeIPAddressAttribute(string appSettingSection)
        {
