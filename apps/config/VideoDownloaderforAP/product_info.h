...
#define PRODUCT_NAME        "VideoDownloaderforAP"
#define FILE_DESCRIPTION    "Video Downloader for AP"
#define FILE_NAME           "VideoDownloaderforAP.exe"

//Windows Store product key
#define STORE_PRODUCT_ID    "XXXXXXXXXXXX"
