...
#define PRODUCT_NAME        "FreeDisneyPlusDownload"
#define FILE_DESCRIPTION    "Free Disney Plus Download"
#define FILE_NAME           "FreeDisneyPlusDownload.exe"

#define VENDING_PRODUCT_ID  "85"
