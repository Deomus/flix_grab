...
// compiler optimizations.
  //vsgcut: UNLIKELY(!(condition)) ? IMMEDIATE_CRASH() : EAT_CHECK_STREAM_PARAMS()
//#define CHECK(condition) \
//    UNLIKELY(!(condition)) ? throw std::exception("ERROR!") : EAT_CHECK_STREAM_PARAMS()
//
