...
#define CHECK_EQ(val1, val2) DCHECK(val1==val2)  
#define CHECK_NE(val1, val2) DCHECK(val1!=val2)
#define CHECK_LE(val1, val2) DCHECK(val1<=val2)  
#define CHECK_LT(val1, val2) DCHECK(val1<val2) 
#define CHECK_GE(val1, val2) DCHECK(val1>=val2)
#define CHECK_GT(val1, val2) DCHECK(val1>val2)  
