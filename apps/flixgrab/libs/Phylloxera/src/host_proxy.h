...
class HostProxy : public cdm::ContentDecryptionModule::Host, public AbstractDecryptService
{
public:
...
public:
    HostProxy(int id, cdm::ContentDecryptionModule::Host* host);
    virtual ~HostProxy();


public:
    void        Init(cdm::ContentDecryptionModule* cdm);
    void        ServiceReady();
...
private:
    ...
    cdm::ContentDecryptionModule::Host*             host_;
    ...
    std::shared_ptr<DecryptServer>                  decrypt_server_;
    std::shared_ptr<BufferPooling>                  buffer_pooling_;

private:
    bool                                            is_cdm_destroyed_;
    bool                                            is_server_finished_;
};